...
def get_uncovered():
    ...
    models = [method for method in methods if method["packageName"] == "be.unamur.game2048.models"]
    controllers = [method for method in methods if method["packageName"] == "be.unamur.game2048.controllers"]
