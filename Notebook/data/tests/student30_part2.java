...
public class Test2048 {
    ...
    */
    ...
    @Test
    public void testGridConstructorEmpty() {
        assertEquals(g.getLength(), GameParams.sideLength);
        for (int col = 0; col < GameParams.sideLength; col++) {
            for (int row = 0; row < GameParams.sideLength; row++) {
                assertNull(g.getTile(row, col));
            }
        }
    }

    @Test
    public void testGridGetTilesOutOfRangeCol() {
        assertThrows(ArrayIndexOutOfBoundsException.class, () -> {
            g.getTile(0, GameParams.sideLength);
        });
    }

    @Test
    public void testGridGetTilesOutOfRangeRow() {
        assertThrows(ArrayIndexOutOfBoundsException.class, () -> {
            g.getTile(GameParams.sideLength, 0);
        });
    }

    @Test
    public void testGridGetTilesOutOfRangeColNegative() {
        assertThrows(ArrayIndexOutOfBoundsException.class, () -> {
            g.getTile(0, -1);
        });
    }
    ...
    @Test
    public void testGridGetTilesOutOfRangeRowNegative() {
        assertThrows(ArrayIndexOutOfBoundsException.class, () -> {
            g.getTile(-1, 0);
        });
    }
    ...
    @Test
    public void testGridGetTilesOutOfRangePos() {
        assertThrows(ArrayIndexOutOfBoundsException.class, () -> {
            g.getTile(GameParams.sideLength * GameParams.sideLength);
        });
    }

    @Test
    public void testGridGetTilesOutOfRangeNegative() {
        assertThrows(ArrayIndexOutOfBoundsException.class, () -> {
            g.getTile(-1);
        });
    }
    ...
    @Test
    public void testGridSetTileOutOfRange() {
        assertThrows(ArrayIndexOutOfBoundsException.class, () -> {
            g.setTile(GameParams.sideLength * GameParams.sideLength, null);
        });
    }

    @Test
    public void testGridSetTileOutOfRangeNegative() {
        assertThrows(ArrayIndexOutOfBoundsException.class, () -> {
            g.setTile(-1, null);
        });
    }
    ...
    @Test
    public void testGridSetTileNull() {
        g.setTile(0, null);
        assertNull(g.getTile(0));
    }
    ...
    public void testGridSetTile() {
        Tile t = new Tile(1);
        g.setTile(0, t);
        assertEquals(g.getTile(0), t);
        assertTrue(g.getTile(0) == t);
    }
