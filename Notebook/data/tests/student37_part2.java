...
public class Test2048 {
    ...
    @Test
    public void testCanMergeWithAlreadyMerged(){
        Tile t1 = new Tile(2);
        Tile t2 = new Tile(2);

        t1.setMerged(true);

        assertTrue(t1.canMergeWith(t2) == false);
        assertTrue(t2.canMergeWith(t1) == false);
    }
    ...
    public void testCanMergeWithNull(){
        ...
        assertTrue(t1.canMergeWith(null) == false);
    }
    ...
    @Test
    public void testFirstEmptyTile(){
        GameController gc = new GameController();
        
        gc.startGame();
        Grid g = gc.getGrid();
        
        for (int i = 0; i < GameParams.nbStartTileFilled; i++) {
            assertFalse(g.getTile(i).equals(null));
        }
    ...
    public void testUpdateScore(){
        ...
        assertTrue(gc.getScore() == 10);
        assertTrue(gc.getHighestScore() == 10);
    }
}
