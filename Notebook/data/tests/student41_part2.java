...
public class Test2048 {
    ...
    public void testTileEquals() {
        ...
        assertTrue(!tuile1.equals(null));
        assertTrue(!tuile1.equals(badTile));
    }
    ...
    @Test
    public void merging(){
        Tile tuituile = new Tile(2);
        Tile tuituituile = new Tile(2);

        tuituile.mergeWith(tuituituile);

        assertTrue(tuituile.isMerged());
    }
    ...
    public void nullTile(){
        Tile tuiletoi = new Tile(2);
        Tile tuiletoit = new Tile(2);

        tuiletoi.mergeWith(tuiletoit);

        assertTrue(!tuiletoi.canMergeWith(null));
        assertTrue(!tuiletoi.canMergeWith(tuiletoit));
